...
$userObj->updateSession();
    ...
    if(isset($_GET['username']) && !empty($_GET['username']) ){
        ...
        $user =$userObj->userData();//user who loggedIN
...
<head>
    ...
    <script
          ...
          <script type="text/javascript">
            // establish our websocet connection: 
...
<div id="profile" class="flex flex-1 justify-center items-center">
    <div class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-center">
        ...
        <div class="right-heading">
            <h2 class="text-center"><?php echo $profileData->username; ?> </h2>
...
<!-- adapter js file , check the browser for webrtc , many browser don't add the new version of webrtc -->
</body>
</html>