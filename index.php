<?php
  ...
  if($userObj->isLoggedIn()){
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST"){//make sure that's a post request
        if(isset($_POST)){
            ...
            //stripcslashes ()used to remove backslashes and clean up data retrieved from a database or from an HTML form
    ...
    <div class="flex-2 flex rounded-xl w-full h-full " >
        ...
        <div class=" flex flex-1 justify-center items-center">
            <div class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-start">
                ...
                <div class="mt-0 w-40 h-60 right-img rounded-full overflow">
                    <img class="h-auto w-full" src="assets/images/user.png" width="100px" height="100px">
                </div>
